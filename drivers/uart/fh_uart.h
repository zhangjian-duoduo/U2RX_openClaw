...
#if defined(CONFIG_ARCH_FH8852V301_FH8662V100) || defined(CONFIG_ARCH_MC632X) || defined(CONFIG_ARCH_FH885xV500) || defined(CONFIG_ARCH_FH8626V300)
#define UART_CLOCK_FREQ (24000000)  /* 24MHZ */
#else
