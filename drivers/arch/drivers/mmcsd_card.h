...
struct rt_mmc_ext_csd
{
    ...
    rt_uint8_t          rel_sectors;
    rt_uint8_t          rel_param;
    rt_uint8_t          part_config;
    ...
    int                 enhanced_area_en;   /* enable bit */
    unsigned long long  enhanced_area_offset;   /* Units: Byte */
    unsigned int        enhanced_area_size; /* Units: KB */
    unsigned int        boot_size;  /* in bytes */
    rt_uint8_t          raw_partition_support;  /* 160 */
    rt_uint8_t          raw_erased_mem_count;   /* 181 */
    rt_uint8_t          raw_ext_csd_structure;  /* 194 */
    rt_uint8_t          raw_card_type;          /* 196 */
    rt_uint8_t          raw_s_a_timeout;        /* 217 */
    rt_uint8_t          raw_hc_erase_gap_size;  /* 221 */
    rt_uint8_t          raw_erase_timeout_mult; /* 223 */
    rt_uint8_t          raw_hc_erase_grp_size;  /* 224 */
    rt_uint8_t          raw_sec_trim_mult;  /* 229 */
    rt_uint8_t          raw_sec_erase_mult; /* 230 */
    rt_uint8_t          raw_sec_feature_support;/* 231 */
    rt_uint8_t          raw_trim_mult;      /* 232 */
    rt_uint8_t          raw_sectors[4];     /* 212 - 4 bytes */
};
