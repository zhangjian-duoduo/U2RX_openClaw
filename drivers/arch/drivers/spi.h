...
#define RT_SPI_IO_CTL_DMA_HIGH_SPEED            0xaa
#define RT_SPI_IO_CTL_DMA_NORMAL_SPEED          0x55
#define RT_SPI_IO_CTL_DMA_RX_ONLY_MODE          0x30
#define RT_SPI_IO_CTL_DMA_TX_RX_MODE            0x31
/**
...
struct rt_spi_bus
{
    ...
    rt_uint32_t dma_speed;
    rt_uint32_t dma_xfer_mode;
    rt_uint32_t max_speed_hz;
    /*add spi bus bind driver private*/
    void *_private;
};
...
/* unregister a SPI bus */
rt_err_t rt_spi_bus_unregister(struct rt_spi_bus       *bus);
