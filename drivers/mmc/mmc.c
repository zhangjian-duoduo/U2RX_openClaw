...
static rt_int32_t mmcsd_mmc_init_card_hw_stack(struct rt_mmcsd_host *host,
                                     rt_uint32_t           ocr)
{
    rt_int32_t err;
    rt_uint32_t resp[4];
...
rt_int32_t init_mmc_hw_only(struct rt_mmcsd_host *host, rt_uint32_t ocr)
{
    rt_int32_t err;
    rt_uint32_t  current_ocr;
    /*
     ...
     * Detect and init the card.
     */
    err = mmcsd_mmc_init_card_hw_stack(host, current_ocr);
    return err;
}
