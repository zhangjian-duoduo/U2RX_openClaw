...
static rt_int32_t mmcsd_sd_init_card_hw_stack(struct rt_mmcsd_host *host,
                                     rt_uint32_t           ocr)
{
    struct rt_mmcsd_card *card;
    rt_int32_t err;
...
rt_int32_t init_sd_hw_only(struct rt_mmcsd_host *host, rt_uint32_t ocr)
{
    rt_int32_t err = 0;
    rt_uint32_t  current_ocr;
    /*
     ...
     * Detect and init the card.
     */
    err = mmcsd_sd_init_card_hw_stack(host, current_ocr);
    return err;
}
