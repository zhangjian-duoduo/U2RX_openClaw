...
#define enc28j60_lock(dev)      rt_mutex_take(&((struct enc28j60_eth *)dev)->lock, RT_WAITING_FOREVER)
#define enc28j60_unlock(dev)    rt_mutex_release(&((struct enc28j60_eth *)dev)->lock)

static struct enc28j60_eth  enc28j60_dev;
...
{
    net_device_ready(&enc28j60_dev.parent);
...
{
    struct enc28j60_eth *enc28j60 = (struct enc28j60_eth *)dev;
...
//            spi_write_op(spi_device, ENC28J60_BIT_FIELD_CLR, EIR, EIR_LINKIF);
            ...
            net_device_linkchange(&(enc28j60->parent), link_status);
        }
...
rt_err_t enc28j60_attach(const char *spi_device_name)
{
    ...
    enc28j60_dev.parent.net.eth.eth_rx  = enc28j60_rx;
    enc28j60_dev.parent.net.eth.eth_tx  = enc28j60_tx;
    ...
    net_device_init(&(enc28j60_dev.parent), "e1", flag, NET_DEVICE_ENC28J60);
