                                        ...
                                        void       *args)
{
    ...
    case 1:
        break;
    case RT_SPI_IO_CTL_DMA_HIGH_SPEED:
        bus->dma_speed = RT_SPI_IO_CTL_DMA_HIGH_SPEED;
        break;
    case RT_SPI_IO_CTL_DMA_NORMAL_SPEED:
        bus->dma_speed = RT_SPI_IO_CTL_DMA_NORMAL_SPEED;
        break;
    case RT_SPI_IO_CTL_DMA_RX_ONLY_MODE:
        bus->dma_xfer_mode = RT_SPI_IO_CTL_DMA_RX_ONLY_MODE;
        break;
    case RT_SPI_IO_CTL_DMA_TX_RX_MODE:
        bus->dma_xfer_mode = RT_SPI_IO_CTL_DMA_TX_RX_MODE;
        break;
    }
...
rt_err_t rt_spi_bus_device_deinit(struct rt_spi_bus *bus)
{
    struct rt_device *device;
    RT_ASSERT(bus != RT_NULL);
...
rt_err_t rt_spidev_device_deinit(struct rt_spi_device *dev)
{
    struct rt_device *device;
    RT_ASSERT(dev != RT_NULL);
