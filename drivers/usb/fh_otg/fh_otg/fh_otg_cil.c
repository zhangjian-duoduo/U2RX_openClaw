...
void fh_otg_hc_start_transfer_ddma(fh_otg_core_if_t *core_if, fh_hc_t *hc)
{
    ...
    hcdma.d32 = 0;
    hcdma.d32 = ((uint32_t) hc->desc_list_addr);
...
static void init_dma_desc_chain(fh_otg_core_if_t *core_if, fh_ep_t *ep)
{
    ...
    uint32_t xfer_est;
    int i;
    unsigned int maxxfer_local, total_len;
...
void fh_otg_ep_start_transfer(fh_otg_core_if_t *core_if, fh_ep_t *ep)
{
    ...
    FH_DEBUGPL(DBG_PCD, "ep%d-%s xfer_len=%d xfer_cnt=%d xfer_buff=%p start_xfer_buff=%p, total_len = %d\n",
...
void fh_otg_ep0_start_transfer(fh_otg_core_if_t *core_if, fh_ep_t *ep)
{
    ...
    FH_DEBUGPL(DBG_PCD, "ep%d-%s xfer_len=%d xfer_cnt=%d xfer_buff=%p start_xfer_buff=%p\n",
            ep->num, (ep->is_in ? "IN" : "OUT"), ep->xfer_len,
            ep->xfer_count, ep->xfer_buff, ep->start_xfer_buff);
                          ...
                          int32_t val)
{
    ...
    core_if->hptxfsiz.d32 = FH_READ_REG32(&core_if->core_global_regs->hptxfsiz);
...
int fh_otg_set_param_dev_tx_fifo_size(fh_otg_core_if_t *core_if, int val,
                       int32_t fifo_num)
{
    int retval = 0;
    /*
...
void fh_otg_set_fr_interval(fh_otg_core_if_t *core_if, uint32_t val)
{
    ...
    {
        FH_WARN("\nCannot reload HFIR register.HFIR.HFIRRldCtrl bit isnot set to 1.\nShould load driver with reload_ctl=1"
             " module parameter\n");
        return;
    }
    switch (fram_int)
    ...
    case 3750:
        ...
        {
            FH_WARN("HFIR interval for HS core and 30 MHzclock freq should be from 3350 to 4150\n");
            return;
        }
        break;
    case 30000:
        ...
        {
            FH_WARN("HFIR interval for FS/LS core and 30 MHzclock freq should be from 26820 to 33180\n");
            return;
        }
        break;
    case 6000:
        ...
        {
            FH_WARN("HFIR interval for HS core and 48 MHzclock freq should be from 5360 to 6640\n");
            return;
        }
        break;
    case 48000:
        ...
        {
            FH_WARN("HFIR interval for FS/LS core and 48 MHzclock freq should be from 42912 to 53088\n");
            return;
        }
        break;
    case 7500:
        ...
        {
            FH_WARN("HFIR interval for HS core and 60 MHzclock freq should be from 6700 to 8300\n");
            return;
        }
        break;
    case 60000:
        ...
        {
            FH_WARN("HFIR interval for FS/LS core and 60 MHzclock freq should be from 53640 to 65536\n");
            return;
        }
        break;
    default:
