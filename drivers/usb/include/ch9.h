...
struct usb_string_descriptor
{
    ...
    rt_uint16_t wData[1];        /* UTF-16LE encoded */
} __attribute__ ((packed));
...
#define    USB_WIRELESS_BEACON_NONE    (3 << 2)
    rt_uint16_t wPHYRates;    /* bit rates, Mbps */
...
struct usb_wireless_ep_comp_descriptor
{
    ...
    rt_uint16_t wMaxStreamDelay;
    rt_uint16_t wOverTheAirPacketSize;
