...
#ifndef __UDC_OTG_DWC_H__
#define __UDC_OTG_DWC_H__
...
extern u32 otg_base;
extern u32 irq_otg;
#define OTG_BASE otg_base
#define IRQ_OTG irq_otg
...
#define GNPTX_STS       (OTG_BASE + 0x2c)
...
#define REG_GNPTX_STS       REG32(GNPTX_STS)
...
#define DIEP_EACHINTMSK(n)     (OTG_BASE + (0x840 + (n)*0x4))
...
#define USBCFG_DESCDMA      BIT23

#define USBCFG_TRDTIME_MASK (0xf << 10)
#define USBCFG_TRDTIME_9    (9 << 10)
#define USBCFG_TRDTIME_6    (6 << 10)
#define USBCFG_PHYSEL    BIT6
#define USBCFG_ULPI_UTMI_SEL    BIT4
#define USBCFG_PHYIF    BIT3
...
/* DIEPMSK */
#define DIEPMSK_NAK         BIT13
#define DIEPMSK_TIMEOUT     BIT3
#define DIEPMSK_AHBERR      BIT2
#define DIEPMSK_EPDISBLD    BIT1
#define DIEPMSK_XFERCMP     BIT0

/* GINTMSK */
#define GINTMSK_WKUP        BIT31
#define GINTMSK_SESS_REQ    BIT30
...
#define GINTSTS_ISOINCMP_INTR    BIT20
...
#define DCFG_DEV_SPDMODE    BIT1
#define DCFG_DEV_SPD        BIT0
/* DSTS */
...
#define DEP_HS_PKTSIZE      UVC_PACKET_SIZE
#else
...
#define DEP_TXFIFO_UNDRN    BIT8
#define DEP_OUTPKT_ERR      BIT8
#define DEP_TXFIFO_EMPTY    BIT7
#define DEP_INEP_NAKEFF     BIT6
#define DEP_B2B_SETUP_RECV  BIT6
#define DEP_INTOKEN_EPMISATCH   BIT5
#define DEP_STATUS_PHASE_RECV   BIT5
#define DEP_INTOKEN_RECV_TXFIFO_EMPTY   BIT4
#define DEP_OUTTOKEN_RECV_EPDIS BIT4
#define DEP_TIME_OUT        BIT3
#define DEP_SETUP_PHASE_DONE    BIT3
#define DEP_AHB_ERR     BIT2
#define DEP_EPDIS_INT       BIT1
#define DEP_XFER_COMP       BIT0
