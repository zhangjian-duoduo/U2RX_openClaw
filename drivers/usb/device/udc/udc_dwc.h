...
#ifndef __UDC_DWC_H__
#define __UDC_DWC_H__
#include <stdint.h>

/*#define DWC_FORCE_SPEED_FULL        0*/

#define UVC_STREAM1_EP1 3 /* IN */
#define UVC_STREAM2_EP1 7 /* IN */
#define USB_CDC_VCOM_EP 4 /* IN &OUT */
#define USB_MSTORAGE_EP 6 /* IN &OUT */
#define USB_HID_EP      8 /* IN &OUT */
#define USB_UAC_EP      5 /* IN &OUT */
#define USB_RNDIS_EP    6 /* IN &OUT */
#define USB_RNDIS_EP_INT  9 /* IN_INT */

#define USB_CDC_EP_SIZE 512
...
#define EP_IDLE             0
#define EP_TRANSFERRED       1
#define EP_TRANSFERRING      2
...
#define DWC_OTG_EP_TYPE_INTR    3
    ...
    void        *data_buff;   /* pointer to transfer buffer */
    void        *data_buff_align;   /* pointer to transfer buffer */

    uint32_t    xfer_len;   /* number of bytes to transfer */
    uint32_t    total_len;   /* number of bytes to transfer */

    uint32_t    xfer_count; /* number of bytes transferred */
...
extern void udc_usbd_event_cb(uint8_t epnum, uint32_t event, void *arg);
#endif /* _UDC_DWC_H_ */
