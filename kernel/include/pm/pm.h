...
{
    int (*suspend_prepare)(const struct rt_device *device, rt_uint8_t mode);
    int (*suspend_late)(const struct rt_device *device, rt_uint8_t mode);
    int (*suspend_noirq)(const struct rt_device *device, rt_uint8_t mode);
    void (*resume_prepare)(const struct rt_device *device, rt_uint8_t mode);
    void (*resume_late)(const struct rt_device *device, rt_uint8_t mode);
    void (*resume_noirq)(const struct rt_device *device, rt_uint8_t mode);
