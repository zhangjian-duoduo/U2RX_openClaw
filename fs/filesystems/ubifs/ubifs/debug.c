                                    ...
                                    struct ubifs_ino_node *ino)
{
    ...
    /* for compile, use inum to get inode. */
    printf("%s,%d,get inode\n", __FUNCTION__, __LINE__);
    inode = ubifs_iget(c->vfs_sb, inum); /* ilookup(c->vfs_sb, inum); */
    /* will malloc buf. */
    if (IS_ERR(inode))
    {
        return (void *)inode;
    ...
    else
    {
        ...
        iput(inode); /* save ,not free. */
        /* ubifs_iput(inode);//this will free. */
    }
...
#ifndef __RT_UBI__ /* disable debug */
