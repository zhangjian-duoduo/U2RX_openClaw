...
static int create_default_filesystem(struct ubifs_info *c)
{
    ...
    if (c->mount_opts.override_compr)
        ...
        sup->default_compr = cpu_to_le16(UBIFS_COMPR_NONE); /* UBIFS_COMPR_LZO UBIFS_COMPR_NONE */
    memset(sup->uuid, 0xff, sizeof(sup->uuid));
    sup->uuid[0] = 0x45;
    ...
    ino->ctime_nsec = 0;
    ino->mtime_nsec = 0;
    ino->mode = cpu_to_le32(S_IFDIR | S_IWUSR);
