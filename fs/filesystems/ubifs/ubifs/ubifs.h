...
#include <linux/asm/atomic-long.h>
#include <ubi_uboot.h>
...
#define get_seconds() iget_seconds()
...
#ifdef __FULLHAN___ /* sys/types.h ,uisigned short */
#define INUM_WARN_WATERMARK 0xFF00
#define INUM_WATERMARK 0xFFF0
#else
...
#ifdef __RT_UBI__ /* __UBOOT__ */
    int (*decompress)(const unsigned char *in, size_t in_len,
                      unsigned char *out, size_t *out_len);
#ifndef __RD_ONLY__
    int (*compress)(const unsigned char *in, size_t in_len,
                    unsigned char *out, size_t *out_len);
#endif
#endif
};
...
#ifndef __RD_ONLY__ /* for write __UBOOT__ */
...
int ubifs_getattr(struct vfsmount *mnt, struct dentry *dentry,
                  struct kstat *stat);
int ubifs_mkdir(struct inode *dir, struct qstr *d_name, umode_t mode);
...
void ubifs_evict_inode(struct inode *inode);
...
/*ubifs.c*/
int do_readpage(struct ubifs_info *c, struct inode *inode,
...
#ifdef __RT_UBI__
void ubifs_umount(struct ubifs_info *c, struct super_block **pSB);
int uboot_ubifs_mount(char *vol_name, int rwFlag, struct super_block **pSuperblock);
void uboot_ubifs_umount(struct super_block **pSuperblock);
int ubifs_init(void);
#endif
