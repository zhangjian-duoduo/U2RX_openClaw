...
#ifndef JFFS2_NAME_MAX
    #define JFFS2_NAME_MAX                  255
#endif

#ifndef JFFS2_PATH_MAX
    #define JFFS2_PATH_MAX                  128 /* the longest file path */
#endif

#ifndef JFFS2_DEVICE_PART_MAX
    #define JFFS2_DEVICE_PART_MAX           2  /* the max partions on a nand deivce*/
#endif
