...
typedef enum
{
	...
	ENCPARAM_CMD_COLOR2GRAY          = 20,// 配置彩色图像编码灰度图像,适用于H264&H265&JPEG&MJPEG | []
...
typedef struct
{
	FH_UINT32 color2gray_enable;   // 是否开始对彩色图像转灰度图像编码 | [0-1]
}ENCPARAM_COLOR2GRAY;
...
typedef union
{
	...
	ENCPARAM_COLOR2GRAY             color2gray;        // 配置彩色图像编码灰度图像 | []
}FH_ENC_PARAM_UNION;
