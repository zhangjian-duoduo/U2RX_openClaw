...
#define CHN0_BUF_SIZE 0x500000
#define OTHER_CHN_BUF_SIZE 0x300000
...
int libpes_send_to_vlc(int channel, char *ip, int port)
{
    ...
    info->memory_limit = channel == 0 ? CHN0_BUF_SIZE / TS_UNITS_MAX_SIZE : OTHER_CHN_BUF_SIZE / TS_UNITS_MAX_SIZE;
    // info->memory_limit = channel == 0 ? 0x800000/TS_UNITS_MAX_SIZE : 0x600000/TS_UNITS_MAX_SIZE;
...
#include "protocol/libpes_srt.c"
#else
#include "protocol/libpes_udp.c"
#endif
